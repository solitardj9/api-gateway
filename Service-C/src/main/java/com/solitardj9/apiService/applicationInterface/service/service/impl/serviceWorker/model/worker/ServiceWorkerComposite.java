...
import com.solitardj9.apiService.applicationInterface.service.service.impl.serviceWorker.model.worker.model.SequenceKey;
	...
	public void executeWork() {
		...
		for (Integer index = 0 ; index < sequence.size() ; index++) {
			...
			if (prevServiceWorkerSingle == null) {
				...
				System.out.println("	2-InputRequestBody = " + prevServiceWorkerSingle.getOutgoingResponseBody());
				System.out.println("//---------------------------------------------");
				nextServiceWorkerSingle.setInputs(prevServiceWorkerSingle.getOutgoingHttpHeaders(), prevServiceWorkerSingle.getOutgoingQueryParams(), prevServiceWorkerSingle.getOutgoingResponseBody());
				System.out.println("//---------------------------------------------");
