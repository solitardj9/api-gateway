...
import com.solitardj9.apiService.applicationInterface.service.service.impl.serviceWorker.model.config.Action;
import com.solitardj9.apiService.applicationInterface.service.service.impl.serviceWorker.model.config.RequestRule;
import com.solitardj9.apiService.applicationInterface.service.service.impl.serviceWorker.model.config.ResponseRule;
import com.solitardj9.apiService.applicationInterface.service.service.impl.serviceWorker.model.function.FunctionExp;
import com.solitardj9.apiService.applicationInterface.service.service.impl.serviceWorker.model.function.TriggerExp;
...
public class ServiceWorkerSingle {
	...
	private TriggerExp extractTrigger(String trigger) {
		...
		while(stringTokenizer.hasMoreTokens()){
			triggerExp.setValue(index, stringTokenizer.nextToken().trim());
			index++;
		}
	...
	private FunctionExp extractFunction(String fuction) {
		...
		while(stringTokenizer.hasMoreTokens()){
			functionExp.setValue(index, stringTokenizer.nextToken().trim());
			index++;
		}
		return functionExp;
	}
